...
function printUsage() {
  ...
  console.log('       mangadl <page_url> [output_dir] [--force] [--cbz] [-GPAC]');
  console.log('       mangadl download <page_url> [output_dir] [--force] [--cbz]');
  console.log('');
